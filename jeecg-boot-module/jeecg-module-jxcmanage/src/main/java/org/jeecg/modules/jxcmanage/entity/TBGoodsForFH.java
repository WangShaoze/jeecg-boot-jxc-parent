...
@Data
@TableName("t_b_goods")
public class TBGoodsForFH implements Serializable {
	...
	/**复称重*/
	@Excel(name = "复称重", width = 15)
    @Schema(description = "复称重")
    private java.math.BigDecimal recheckWeight;
	/**银重*/
    ...
    private java.lang.String outboundId;
}
